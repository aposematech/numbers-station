...
resource "aws_secretsmanager_secret" "secret_transmission" {
...
resource "aws_secretsmanager_secret_version" "secret_transmission_version" {
  secret_id     = aws_secretsmanager_secret.secret_transmission.id
  secret_string = var.secret_transmission_value
}
