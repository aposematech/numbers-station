...
def handler(event, context):
    ...
    plain_text = get_alpha_only(parameters.get_parameters_by_name(os.environ['SECRET_TRANSMISSION_NAME']))
    ...
    # get secrets
    twitter_consumer_key = parameters.get_parameters_by_name(os.environ['TWITTER_CONSUMER_KEY_NAME'])
    twitter_consumer_secret = parameters.get_parameters_by_name(os.environ['TWITTER_CONSUMER_SECRET_NAME'])
    twitter_access_token = parameters.get_parameters_by_name(os.environ['TWITTER_ACCESS_TOKEN_NAME'])
    twitter_access_token_secret = parameters.get_parameters_by_name(os.environ['TWITTER_ACCESS_TOKEN_SECRET_NAME'])
    # upload qrcode
